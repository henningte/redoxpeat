...
\begin{abstract}
Methane production in peatlands is controlled by the availability of
electron acceptors for microbial respiration, including peat dissolved
(DOM) and particulate organic matter (POM). Despite the much larger mass
of POM in peat, knowledge on the ranges of its electron transfer
capacities (electron accepting capacity -- EAC, and electron donating
capacity -- EDC) is scarce in comparison to DOM and humic and fulvic
acids. Moreover, it is unclear how peat POM chemistry and decomposition
relate to its EAC and EDC. To address these knowledge gaps, we compiled
peat samples with varying carbon contents from mid to high latitude
peatlands and analyzed their EAC\(_\text{POM}\) and EDC\(_\text{POM}\),
element ratios, decomposition indicators, and relative amounts of
molecular structures as derived from mid infrared spectra. Peat
EAC\(_\text{POM}\) and EDC\(_\text{POM}\) are smaller (per gram carbon)
than EAC and EDC of DOM and terrestrial and aquatic humic and fulvic
acids and are highly variable within and between sites. Both are small
in highly decomposed peat, unless it has larger relative amounts of
quinones and phenols. Element ratio-based models failed to predict
EAC\(_\text{POM}\) and EDC\(_\text{POM}\), while mid infrared
spectra-based models can predict peat EAC\(_\text{POM}\) to a large
extent, but not EDC\(_\text{POM}\). We suggest a conceptual model that
describes how vegetation chemistry and decomposition control polymeric
phenol and quinone contents as drivers of peat EDC\(_\text{POM}\) and
EAC\(_\text{POM}\). The conceptual model implies that we need
mechanistic models or spatially resolved measurements to understand the
variability in peat EDC\textsubscript{POM} and EAC\textsubscript{POM}
and thus its role in controlling methane formation.
\end{abstract}
...
recently, it has been found that the peat itself can reversibly transfer
electrons and that its capacities to reversibly accept (electron
accepting capacity, EAC) and reversibly donate (electron donating
capacity, EDC) electrons are large. We investigated which conditions
favour large or low EAC and EDC of peat so that we can better explain
methane formation. We argue that vegetation and decomposition control
the amount of phenols and quinones --- molecules in the peat that
presumably are responsible for most of the peat's EAC and EDC. The EAC
and EDC probably are largest for peat formed from vegetation rich in
quinones and phenols, such as shrubs, and smaller for other vegetation
types, e.g.~certain mosses. Intense decomposition may reduce both the
EAC and EDC.
\vskip18pt
...
\nocite{Aeschbacher.2010, Aeschbacher.2011, Aeschbacher.2012, Anisimov.2007, Artz.2008, Bader.2018, Bai.2020, Bellocchi.2010, Bengtsson.2018, Benner.1984, Biester.2014, Blodau.2007, Blodau.2011, Bolton.2018, Bowring.2020, Bragazza.2007, Broder.2012, Chaudhary.2020, Cocozza.2003, Danielson.2011, Drollinger.2020, Elliott.2012, ElMansouri.2007, Engel.2013, Fenner.2011, Ferragina.2015, Fick.2017, Fimmen.2007, Frolking.2011, Gao.2019, Heffernan.2020, Heitmann.2006, HernandezMontoya.2012, Hodgkins.2018, Hotta.2002, HuffmanLaboratories.NA, Johnson.2015, Kang.2018c, Keller.2013, Kim.2003, Klupfel.2014, Koven.2011, Kubo.2005, LaCroix.2020, Larina.2013, Lau.2015, Lau.2016, Leifeld.2012, Leifeld.2020, Limpens.2008, Lipczynska-Kochany.2018, Loisel.2014, Lu.2015, Lv.2018, Masiello.2008, Mathijssen.2019, Moore.1989, Moore.2018, Myhre.2013, Olk.2006, Piironen.2020, Poisot.2011, Ratasuk.2007, Roberts.2017, Rydin.2013, Sagerfors.2008, Scheffer.2001, Schellekens.2015, Schmidt.2006, signaldevelopers.2014, South.2017, Strakova.2010, Stuart.2005, Tamura.1974, Tan.2017, Teickner.2020, Teickner.2020b, Tfaily.2014, Tipping.2016, Tsuneda.2001, Uchimiya.2009, Walpen.2018, Walpen.2018b, Wang.2015, Wang.2015b, Wertebach.2016, Williams.1998, Worrall.2016b, Worrall.2017, Yavitt.1997, Yu.2016, Yuan.2018, Zak.2019, Zhao.2020}

\bibliography{references}

\nocitesi{Baath.2018, Bache.2014, Beleites.2020, Bivand.2020, Carpenter.2017, Gabry.2019, Gabry.2019b, Gelman.2014b, Goodrich.2020, Henry.2020, Hijmans.2020, Kruschke.2015, Mevik.2019, Moore.2007, Pebesma.2005, Pebesma.2016, Pebesma.2018b, Pedersen.2019, Piironen.2017, Piironen.2017c, Piironen.2019, RCoreTeam.2020, Scheffer.2000, Slowikowski.2020, StanDevelopmentTeam.2020, Teickner.2020e, Ucar.2019, Wickham.2016, Wickham.2020e, Wickham.2020f, Wilke.2019}
