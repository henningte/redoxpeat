...
#include "stanExports_rp_regression_gamma1.h"

RCPP_MODULE(stan_fit4rp_regression_gamma1_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_rp_regression_gamma1")
