...
namespace model_rp_regression_gamma2_student_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rp_regression_gamma2_student");
    reader.add_event(87, 85, "end", "model_rp_regression_gamma2_student");
    return reader;
}
#include <stan_meta_header.hpp>
class model_rp_regression_gamma2_student
  : public stan::model::model_base_crtp<model_rp_regression_gamma2_student> {
private:
        int N_i;
        int N_j;
        int k;
        ...
        double nu_betas;
public:
    model_rp_regression_gamma2_student(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_rp_regression_gamma2_student_namespace::model_rp_regression_gamma2_student";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "nu_betas", "double", context__.to_vec());
            nu_betas = double(0);
            vals_r__ = context__.vals_r("nu_betas");
            pos__ = 0;
            nu_betas = vals_r__[pos__++];
            check_greater_or_equal(function__, "nu_betas", nu_betas, 0);
    ...
    ~model_rp_regression_gamma2_student() { }
        ...
        try {
            ...
            for (int i = 1; i <= N_j; ++i) {
                ...
                stan::model::assign(y_layers_mu, 
                            ...
                            stan::math::exp((beta_0 + multiply(stan::model::rvalue(X, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X"), betas))), 
            ...
            for (int i = 1; i <= k; ++i) {
                ...
                lp_accum__.add(student_t_log<propto__>(get_base1(betas, i, "betas", 1), nu_betas, get_base1(mu_betas, i, "mu_betas", 1), get_base1(sigma_betas, i, "sigma_betas", 1)));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_rp_regression_gamma2_student_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_rp_regression_gamma2_student";
    }
...
typedef model_rp_regression_gamma2_student_namespace::model_rp_regression_gamma2_student stan_model;
#ifndef USING_R
