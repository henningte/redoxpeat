...
#include "stanExports_rp_regression_gamma2_student_prior_check.h"

RCPP_MODULE(stan_fit4rp_regression_gamma2_student_prior_check_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_rp_regression_gamma2_student_prior_check")
