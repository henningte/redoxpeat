...
namespace model_rp_regression_gamma2_student_prior_check_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rp_regression_gamma2_student_prior_check");
    reader.add_event(48, 46, "end", "model_rp_regression_gamma2_student_prior_check");
    return reader;
}
#include <stan_meta_header.hpp>
class model_rp_regression_gamma2_student_prior_check
  : public stan::model::model_base_crtp<model_rp_regression_gamma2_student_prior_check> {
private:
        int N_i;
        int N_j;
        int k;
        ...
        double nu_betas;
public:
    model_rp_regression_gamma2_student_prior_check(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_rp_regression_gamma2_student_prior_check_namespace::model_rp_regression_gamma2_student_prior_check";
    ...
    ~model_rp_regression_gamma2_student_prior_check() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_rp_regression_gamma2_student_prior_check_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(beta_0,normal_rng(mu_beta_0, sigma_beta_0, base_rng__));
            ...
            for (int i = 1; i <= k; ++i) {
                ...
                stan::model::assign(betas, 
                            ...
                            student_t_rng(nu_betas, get_base1(mu_betas, i, "mu_betas", 1), get_base1(sigma_betas, i, "sigma_betas", 1), base_rng__), 
    ...
    std::string model_name() const {
        return "model_rp_regression_gamma2_student_prior_check";
    }
...
typedef model_rp_regression_gamma2_student_prior_check_namespace::model_rp_regression_gamma2_student_prior_check stan_model;
#ifndef USING_R
