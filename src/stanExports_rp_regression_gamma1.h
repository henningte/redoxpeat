...
namespace model_rp_regression_gamma1_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rp_regression_gamma1");
    reader.add_event(81, 79, "end", "model_rp_regression_gamma1");
    return reader;
}
#include <stan_meta_header.hpp>
class model_rp_regression_gamma1
  : public stan::model::model_base_crtp<model_rp_regression_gamma1> {
private:
        int N_i;
        int N_j;
        int k;
...
public:
    model_rp_regression_gamma1(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_rp_regression_gamma1_namespace::model_rp_regression_gamma1";
        ...
        try {
            ...
            for (int i = 1; i <= N_j; ++i) {
                ...
                stan::model::assign(y_layers_mu, 
                            ...
                            stan::math::exp((beta_0 + multiply(stan::model::rvalue(X, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X"), elt_multiply(betas, sigma_betas)))), 
            ...
            lp_accum__.add(normal_log<propto__>(betas, mu_betas, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_rp_regression_gamma1_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_rp_regression_gamma1";
    }
...
typedef model_rp_regression_gamma1_namespace::model_rp_regression_gamma1 stan_model;
#ifndef USING_R
